## md49_base_controller (melodic) - 0.1.4-1

The packages in the `md49_base_controller` repository were released into the `melodic` distro by running `/usr/bin/bloom-release md49_base_controller --track melodic --rosdistro melodic --new-track` on `Fri, 22 Mar 2019 18:37:25 -0000`
...
## md49_base_controller (groovy) - 0.1.4-0

The packages in the `md49_base_controller` repository were released into the `groovy` distro by running `/usr/bin/bloom-release md49_base_controller --track groovy --rosdistro groovy --new-track` on `Sat, 26 Dec 2015 20:44:51 -0000`
...
## md49_base_controller (indigo) - 0.1.4-1
